    ...
    <div className="flex flex-col lg:flex-row lg:items-center gap-4 mb-6">
      ...
      <div className="flex flex-row items-center gap-3 lg:flex-shrink-0">
        <div className="flex items-center space-x-2">
          ...
          <div className="flex items-center bg-[#141824]/60 border border-white/10 rounded-lg overflow-hidden">
            <button
              type="button"
            ...
            <input 
              ...
              placeholder="10" 
              className="w-20 px-3 py-2 bg-transparent text-white text-sm placeholder:text-white/50 focus:outline-none" 
            />
          </div>
        </div>
        <div className="flex items-center space-x-2">
        ...
        <div className="flex items-center space-x-1 sm:space-x-2">
          ...
          <input
            ...
            className="px-2 py-2 bg-gray-800 border border-gray-600 rounded-md text-white text-sm placeholder-gray-400 focus:outline-none focus:border-blue-500 w-24 sm:w-32"
          />
        </div>
        <div className="flex items-center space-x-2">
        ...
        <div className="ml-auto">
          <button onClick={() => updateURL(tradeId)} className="px-3 py-2 bg-blue-600 text-white rounded-md text-sm hover:bg-blue-500">Search</button>
        </div>
      </div>
    </div>
  )
